...
Full-stack LMS with session-based authentication and role-based access  
Live: https://learnnet-web.onrender.com/

### URL Shortener
Scalable MongoDB-backed URL management system  
Live: https://url-shortener-9dhg.onrender.com/

### College Event Management System
Campus event scheduling and registration platform  
